...
<?php get_header(); ?>
			...
			<div id="content-home" class="container-fluid clearfix row-fluid">
				...
				<div id="main" class="span12 clearfix" role="main">
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
						...
						<header>
							...
							<div class="hero-unit visible-phone" style="background-image: url('<?php echo $featured_src; ?>'); background-repeat: no-repeat; background-position: 0 0;">
